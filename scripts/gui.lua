...
rr.subscribe(data, function(tbl) data = tbl end)
...
rr.add(defines.events.on_player_created, function(event)
...
rr.add(defines.events.on_player_removed, function(event)
